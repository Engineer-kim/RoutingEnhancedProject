...
import EventDetailPages , { loader as eventDetailLoader } from './pages/EventDetail';
    ...
    children: [
      { index: true, element: <HomePage /> },
      {
        path: 'event', element: <EventRootLayout />, children: [
          {
            index: true, element: <EventPages />, loader: eventDetailLoader
          },
          { path: ':eventId', element: <EventDetailPages />, loader },
